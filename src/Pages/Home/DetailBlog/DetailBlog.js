...
const DetailBlog = () => {
    ...
    const handleDeleteComment = () => {
        // fetch(`http://localhost:5000/deletecomment?id=${_id}`, {
        //     method: 'DELETE'
        // })
        // .then(res => res.json())
        // .then(data => {
            ...
            <div className='mx-auto md:max-w-[1240px] detailsBg'>
                ...
                <div className='bg-[#1e4752] p-4 mt-20 rounded-md  commentsbg'>
                    ...
                    <div className=' bg-[#ededed] rounded-md w-full p-2 '>
                        {nameCondition && <p className='mb-2'>You can type your name in the comment like <span className='font-bold'>from: John smith</span> <span className='text-red-500'>- "at last of your comment"</span></p>}
                        <textarea
                            value={commentBody}
