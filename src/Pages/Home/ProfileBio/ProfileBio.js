...
const ProfileBio = () => {
    return (
        ...
        <div className='flex-1 mx-6 md:mx-0 mt-10 md:mt-0'>
            ...
            <a target='blank' href="https://github.com/spsujoy007"><button className='btn btn-info btn-outline mt-3 rounded-full commonbtn'><FaGithub className='mr-2 text-xl'></FaGithub>  Github Profile</button></a>
