...
const Footer = () => {
    return (
        <div className='lg:px-5  py-16 bg-gray-900 rounded-t-2xl'>
            <div className='mx-auto px-20 md:max-w-[1440px] grid md:grid-cols-2' >
            <div>
                ...
                <div>
                <h3 className='text-xl text-white mt-2'>Copyright © 2023 - All right reserved by <span className="text-sky-500 font-bold">SUJOY PAUL</span></h3>
                <p className='text-base-300 mt-3'>Developing software for the world of intent is something I'm passionate about and I'm dedicated to making the world of intent easy and affordable for everyone. Visit my <span className="text-sky-500 underline"><a target='blank' href="https://github.com/spsujoy007">github profile.</a></span> website UI idea from "Raihan Hosen".</p>
                </div>
            </div>
