        ...
        <div className='h-full'>
            {
                ...
                <div className='absolute top-[48vh]  left-3 z-[80] '>
                    ...
                    <div>
                    <a className='rounded-full hover:text-sky-500 duration-200 text-3xl shadow-xl github-bulb shadow-sky-500 text-white' target='blank' href='https://github.com/spsujoy007'><FaGithub className='github-bulb'></FaGithub></a>
                    </div>
